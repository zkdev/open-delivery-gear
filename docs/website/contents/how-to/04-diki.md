...
[REST-API-documentation](https://github.com/open-component-model/delivery-service?tab=readme-ov-file#rest-api-documentation).
```

## Creating Diki compliance issues

To have `Diki` issues generated by the issue-replicator, the `Diki` findings
