...
2. *Finding Types*
   ...
   have to provide a initial [discovery-date](#discovery-date) together with their
   ...
   fallback (see
   {doc}`issue-replicator extension </contents/concepts/03-issue-replicator>`). The
